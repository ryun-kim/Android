...
public class MovieDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO - moviceCd 값 전 Activity (MovieListActivity)에서 받는다.
    }
    private void getData(){
        ...
        final String KEY = "7c108255f09f63acdf88958b4f540ce0";
        ...
        call.enqueue(new Callback<MovieInfoResultBodyVO>() {
            ...
            @Override
            public void onFailure(Call<MovieInfoResultBodyVO> call, Throwable t) { //baseUrl이 틀리거나, 그 서버가 죽어있을 때 , 망에 문제가 있을때
